...
val storageAccountName = "onestorageaccountazure"
val appID = "469455e9-dd7f-4b80-9e0d-c1afaa86a41b"
val password = "KKrYgQGjQri8J=1@UtU/09AbAZ:n-B@s"
val fileSystemName = "onefilesystemgen2"
val tenantID = "8a7bb8e8-a0ba-4b1a-95cb-5169eb7ae0f0"
...
// MAGIC            "fs.azure.account.oauth2.client.id": "469455e9-dd7f-4b80-9e0d-c1afaa86a41b",
// MAGIC            "fs.azure.account.oauth2.client.secret": "KKrYgQGjQri8J=1@UtU/09AbAZ:n-B@s",
// MAGIC            "fs.azure.account.oauth2.client.endpoint": "https://login.microsoftonline.com/8a7bb8e8-a0ba-4b1a-95cb-5169eb7ae0f0/oauth2/token"}
// MAGIC 
// MAGIC # Optionally, you can add <directory-name> to the source URI of your mount point.
// MAGIC dbutils.fs.mount(
// MAGIC   source = "abfss://onefilesystemgen2@onestorageaccountazure.dfs.core.windows.net/",
// MAGIC   mount_point = "/mnt/sid",
